<div class="text-center mt-5">
    ...
    <div class="mt-2">
        <input type="radiobutton" name="checkmale" id="gender" value="male" class="btn-check">
        <label for="gender" class="btn btn-outline-primary">Male</label>
        <input type="radiobutton" name="checkfemale" id="gender" value="female" class="btn-check">
